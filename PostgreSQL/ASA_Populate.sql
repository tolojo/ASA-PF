...
insert into zona(zona_area_geografica, zona_nome) VALUES (CIRCLE(Point(38.7091073,-9.1667920),5),'Estrela');

insert into localidade(local_localizacao, local_nome, local_zona_id) VALUES ('38.7173115, -9.1680233', 'Rua Azedo Gneco',1);
insert into localidade(local_localizacao, local_nome, local_zona_id) VALUES ('38.7091073, -9.1667920', 'Aven Santo',2);
...
insert into alerta(alerta_nome, alerta_descricao, alerta_localizacao, alerta_pessoa_id, alerta_ta_id) VALUES ('Falta de roupa','Sem abrigo na estrela esta com falat de roupa para o inverno','38.7091073, -9.1667920',2,2);
